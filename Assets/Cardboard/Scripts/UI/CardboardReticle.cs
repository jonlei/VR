...
public class CardboardReticle : MonoBehaviour, ICardboardGazePointer {
  ...
  private void CreateReticleVertices() {
    ...
    //private void CreateReticleVerticesAnim(float AnimTime)
    //{
    //    Mesh mesh = new Mesh();
    ...
    //    Vector3[] vertices2 = new Vector3[vertex_count];
    ...
    //        vertices2[vi++] = new Vector3(x,y+1,0.0f);
    //        vertices2[vi++] = new Vector3(x,y +1, 1.0f);
    //    }
    //    #endregion
